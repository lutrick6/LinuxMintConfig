...
organize(){
  ...
  find $downloads -type f \( -iname "*.jpg" -o -iname "*.png" -o -iname "*.jpeg" \) -print0 | xargs -0 -I '{}' /bin/mv "{}" /home/ilucid/Pictures;
  find $downloads -type f \( -iname "*.mp4" -o -iname "*.mkv" \) -print0 | xargs -0 -I '{}' /bin/mv "{}" /home/ilucid/Videos;
  find $downloads -type f \( -iname "*.txt" -o -iname "*.doc" -o -iname "*.pdf" \) -print0 | xargs -0 -I '{}' /bin/mv "{}" /home/ilucid/Documents;
  find $downloads -type f \( -iname "*.mp3" \) -print0 | xargs -0 -I '{}' /bin/mv "{}" /home/ilucid/Music;
  find $downloads -type f \( -iname "*.gif" \) -print0 | xargs -0 -I '{}' /bin/mv "{}" /home/ilucid/Pictures/GIFs
}
